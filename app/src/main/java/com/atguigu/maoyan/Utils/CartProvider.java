...
public class CartProvider {
    ...
    private List<ShoppingCart> getDataFromLocal() {
        ...
        String json = CashUtils.getString(context, JSON_CART);
    ...
    private void commit() {
        ...
        CashUtils.putString(context, JSON_CART, json);
    }
    ...
    public ShoppingCart conversion(Shumabean.DataBean.ListBean wares) {
        ShoppingCart cart = new ShoppingCart();
        cart.setDealid(wares.getDealid());
        cart.setTitle(wares.getTitle());
        cart.setPic(wares.getPic());
        cart.setShortTitle(wares.getShortTitle());
